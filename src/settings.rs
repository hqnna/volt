...
pub fn known_settings() -> Vec<SettingDef> {
    vec![
        ...
        SettingDef {
            ...
            setting_type: SettingType::Boolean,
            default: Value::Bool(true),
            description: "Play notification sounds on task completion / input needed",
            enum_options: None,
        },
        SettingDef {
            ...
            setting_type: SettingType::Boolean,
            default: Value::Bool(true),
            description: "Add Amp-Thread: trailer to git commits",
            enum_options: None,
        },
        SettingDef {
            ...
            setting_type: SettingType::Boolean,
            default: Value::Bool(true),
            description: "Add Co-authored-by: Amp trailer to git commits",
            enum_options: None,
        },
        SettingDef {
            ...
            setting_type: SettingType::Boolean,
            default: Value::Bool(true),
            description: "Clipboard integration for tab",
            enum_options: None,
        },
        SettingDef {
            ...
            description: "Personal access token for Bitbucket Enterprise",
            enum_options: None,
        },
        SettingDef {
            key: "amp.skills.path",
            setting_type: SettingType::String,
            default: Value::String(String::new()),
            description: "Colon-separated paths to additional skill directories",
            enum_options: None,
        },
        SettingDef {
        ...
        SettingDef {
            ...
            setting_type: SettingType::StringEnum,
            default: Value::String(String::new()),
            description: "Load env from shell profile",
        ...
        SettingDef {
            ...
            setting_type: SettingType::StringEnum,
            default: Value::String(String::new()),
            description: "Deep mode reasoning effort",
        ...
        SettingDef {
            ...
            description: "Default thread visibility per repo origin",
            enum_options: None,
        },
        SettingDef {
            ...
            description: "Glob patterns always included in fuzzy file search",
            enum_options: None,
        },
        // Permissions
        SettingDef {
            ...
            default: Value::Array(vec![]),
            description: "Tool permission rules (allow/reject/ask)",
            enum_options: None,
        },
        // Tools
        SettingDef {
            ...
            setting_type: SettingType::ArrayString,
            default: Value::Array(vec![]),
            description: "Disable specific tools by name (glob patterns supported)",
            enum_options: None,
        },
        SettingDef {
            ...
            description: "Seconds before canceling a running tool",
            enum_options: None,
        },
        // MCPs
        SettingDef {
        ...
        SettingDef {
            ...
            setting_type: SettingType::ArrayObject,
            default: Value::Array(vec![]),
            description: "Allow/block MCP servers by pattern",
            enum_options: None,
        },
    ]
}
